...
export function GalleryPage() {
  ...
  return (
    <div className="w-full min-h-screen bg-neutral-950 text-white flex flex-col items-center p-10">
            ...
            <table className="min-w-full text-sm text-slate-300">
              ...
              <tbody>
                {savedImages.map((img) => (
                  <tr
                    key={img.id}
                    className="border-t border-slate-800 hover:bg-neutral-800/50 transition"
                  >
